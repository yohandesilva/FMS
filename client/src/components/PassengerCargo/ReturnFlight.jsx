...
import { Plane, Clock, Calendar, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-blue-800 mb-8">Available Return Flights</h1>
          ...
          <div className="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <div className="flex items-center mb-4 sm:mb-0">
                ...
                <div>
                  <p className="text-xl font-bold">ABU DHABI TO COLOMBO</p>
                  <p className="text-sm opacity-90">Zayed International Airport (AUH) to Bandaranaike Intl (CMB)</p>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6">
              <div className="flex items-center mb-4 md:mb-0">
                <div className="text-center">
                  <p className="text-2xl font-bold text-gray-800">10:20</p>
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-gray-800">14:55</p>
              ...
              <div className="bg-blue-50 rounded-lg p-3 w-full md:w-auto">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-xs text-blue-600">UL 226 • Airbus A330-200</p>
                  </div>
                  <div className="text-right">
                    <p className="text-xl font-bold text-blue-700">LKR 59,450</p>
            ...
            {showDetails && (
              <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-baseline">
                        <h4 className="font-medium text-blue-800">Srilankan Airlines UL 226</h4>
                ...
                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h4 className="font-medium text-blue-800 mb-2">Baggage Information</h4>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h4 className="font-medium text-blue-800 mb-2">Fare Rules</h4>
                    <div className="flex justify-between text-sm">
        ...
        <div className="text-center mt-8">
          <button className="px-6 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition duration-200 font-medium">
            Show More Flights
          </button>
        </div>
      </div>
